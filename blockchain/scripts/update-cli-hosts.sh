...
# Script to update the hosts file in the CLI container with the correct IP addresses
...
$PEER1_DISTRICT_IP peer1.district.gov.in"
    ...
    print_color "info" "Hosts file updated successfully in CLI container."
}
...
verify_cli_hosts() {
    ...
    print_color "info" "Hosts file verified successfully."
}

# Main function
main() {
    print_color "info" "Starting hosts file update for CLI container..."
